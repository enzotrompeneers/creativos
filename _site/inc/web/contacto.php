<section class="content-container interna">
	...
	<div class="design-outer">
		<div class="design-inner">
			...
			<div class="design-middle-blk">
				<div class="rotate-block">
					<div class="middle-left middle-left1">
						<h2>
							<?=trad('diseno_ux')?>
						</h2>
						<p>
					...
					<svg class="left-circle" viewBox="0 0 250 250" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink">
		...
		c41.421,0,75-33.58,75-75C150,33.579,116.421,0,75,0L75,0z">
							<animateTransform attributeName="transform" attributeType="XML" type="rotate" from="0 75 75" to="360 75 75" dur="15s" repeatCount="indefinite"
							/>
						</path>
					</svg>
					...
					<svg class="right-circle" viewBox="0 0 250 250" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink">
		...
		S36.901,9.715,45.826,5.94C55.066,2.032,64.882,0.05,75,0.05 M75,0C33.578,0,0,33.579,0,75c0,41.419,33.579,75,75,75
		c41.421,0,75-33.58,75-75C150,33.579,116.421,0,75,0L75,0z">
							<animateTransform attributeName="transform" attributeType="XML" type="rotate" from="360 75 75" to="0 75 75" dur="15s" repeatCount="indefinite"
							/>
						</path>
					</svg>
		...
		<div class="contact-blk">
			<div class="contact-top">
				...
				<div class="contact-right">
					...
					<a href="mailto:<?= webConfig('email') ?>" class="mail">
						<?= webConfig('email') ?>
					</a>
				</div>
			</div>
			<div class="contact-top grey-blk">
				<div class="contact-left">
					...
					<address>
						<p>
							<?= webConfig('calle_alicante') ?>
							<br>
							<?= webConfig('codigo_postal_alicante') ?>Alicante</p>
					</address>
				</div>
				<div class="contact-right">
					<a href="tel:<?= webConfig('telefono_alicante') ?>">
						<?= webConfig('telefono_alicante') ?>
					</a>
					<a href="mailto:<?= webConfig('email_alicante') ?>" class="mail">
						<?= webConfig('email_alicante') ?>
					</a>
				</div>
