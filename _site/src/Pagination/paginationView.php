...
echo "<ul class=\"pagination\" align=\"right\"  role=\"navigation\" aria-label=\"Pagination\">\n";	

if($next < 1)
{
  $next =  "<li class=\"arrow unavailable\"><a href=\"\">".trad('siguiente')."</a></li>";
}

if($next >= 1)
{
  $next = "<li><a href=\"$location=$next\" title=\"\">".trad('siguiente')."</a></li>";
}

if($previous < 1)
{
  $previous =  "<li class=\"arrow unavailable\"><a href=\"\">".trad('anterior')."</a></li>";
}

if($previous >= 1)
{
  $previous = "<li><a href=\"$location=$previous\" title=\"\">".trad('anterior')."</a></li>";
}
