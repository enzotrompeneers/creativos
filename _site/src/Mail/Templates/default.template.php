...
<style type="text/css">
	...
	#headline h1 { color:#ddd !important;  }
...
<table id="background-table" border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td align="center" bgcolor="#dedede"><table class="w640" style="margin:0 10px;" border="0" cellpadding="0" cellspacing="0" width="640">
          <tbody>
            <tr>
            ...
            <tr>
              <td id="header" class="w640" align="center" bgcolor="#fff" width="640"><table class="w640" border="0" cellpadding="0" cellspacing="0" width="640">
                  <tbody>
                    <tr>
            ...
            <tr>
              <td class="w640" bgcolor="#f8f8f8" height="30" width="640"></td>
            </tr>
            <tr id="simple-content-row">
              <td class="w640" bgcolor="#f8f8f8" width="640"><table class="w640" border="0" cellpadding="0" cellspacing="0" width="640">
                  <tbody>
                    <tr>
                      <td class="w30" width="30"></td>
                                ...
                                <tr>
                                  <td class="w580" width="580"><p class="article-title" align="left">
                                    ...
                                    <div class="article-content" align="left">
																			...
																			<br>
																			<?php if (isset($extraData)) echo $extraData ?>
            ...
            <tr>
              <td class="w640" bgcolor="#f8f8f8" height="15" width="640"></td>
            </tr>
            <tr>
              <td class="w640" width="640"><table id="footer" class="w640" bgcolor="#c7c7c7" border="0" cellpadding="0" cellspacing="0" width="640">
                  <tbody>
                    <tr>
                      <td class="w30" width="30"></td>
